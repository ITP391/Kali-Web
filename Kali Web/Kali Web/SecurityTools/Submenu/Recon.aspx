        ...
        <div class="col-md-4">
            <div class="box box-large">    
                ...
                <div class="box-content">
                    ...
                    <p class="tool-link"><a href="/SecurityTools/ToolUI/nmap.aspx" class="button">Click Here for the tool</a> </p>
                </div>
            </div>
        </div>
         <%--Container for a box of a category--%>
        <div class="col-md-4">
            <div class="box box-large">    
                ...
                <div class="box-content">
                    ...
                    <p class="tool-link"><a href="/SecurityTools/ToolUI/Wireshark.aspx" class="button">Click Here for the tool</a> </p>
                </div>
            </div>
        </div>     
         <%--Container for a box of a category--%>
        ...
        <div class="col-md-4">
             <div class="box box-large">
                ...
                <div class="box-content">
                    ...
                    <p class="tool-link"><a href="/SecurityTools/ToolUI/ping.aspx" class="button">Click Here for the tool</a> </p>
                </div>
            </div>
        </div>
    </div>
