        ...
        <div class="col-md-4">
            <div class="box box-large">
                ...
                <div class="box-content">
                    ...
                    <p class="tool-link"><a href="/SecurityTools/ToolUI/Hashcat.aspx" class="button">Click Here for the tool</a> </p>
                </div>
            </div>
        </div>  
         <%--Container for a box of a category--%>
        <div class="col-md-4">
            <div class="box box-large">   
                ...
                <div class="box-content">
                    ...
                    <p class="tool-link"><a href="/SecurityTools/ToolUI/ncrack.aspx" class="button">Click Here for the tool</a> </p>
                </div>
            </div>
        </div>         
        <%--Container for a box of a category--%>
