<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="nmapVul.aspx.cs" Inherits="Kali_Web.Security_Tools.Tool_UI.nmapVul" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="main-content">

        <h2 style="margin-top: 35px">Nmap - Network Mapper (Vulnerability Scan)</h2>
