<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SSHPing.aspx.cs" Inherits="Kali_Web.Security_Tools.Tool_UI.SSHPing" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
        <div class="main-content">

        <h2 style="margin-top: 35px">Windows Ping Tool (SSH Version)</h2>
