<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SSHRecon.aspx.cs" Inherits="Kali_Web.Security_Tools.Submenu.SSHRecon" %>
        ...
        <div class="col-md-4">
            <div class="box box-large">    
                ...
                <div class="box-content">
                    ...
                    <p class="tool-link"><a href="/Security Tools/Tool UI/SSHNmap.aspx" class="button">Click Here for the tool</a> </p>
                </div>
            </div>
        </div>
         <%--Container for a box of a category--%>
        <div class="col-md-4">
            <div class="box box-large">    
                ...
                <div class="box-content">
                    ...
                    <p class="tool-link"><a href="/Security Tools/Tool UI/SSHWireshark.aspx" class="button">Click Here for the tool</a> </p>
                </div>
            </div>
        </div>     
         <%--Container for a box of a category--%>
        ...
        <div class="col-md-4">
             <div class="box box-large">
                ...
                <div class="box-content">
                    ...
                    <p class="tool-link"><a href="/Security Tools/Tool UI/SSHPing.aspx" class="button">Click Here for the tool</a> </p>
                </div>
            </div>
        </div>
    </div>
