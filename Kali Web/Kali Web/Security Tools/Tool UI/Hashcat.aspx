            ...
            <section id="loginForm">
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        <asp:Label runat="server" AssociatedControlID="Hash" CssClass="col-md-2 control-label">Hash</asp:Label>
                        <div class="col-md-10">
                            <asp:TextBox runat="server" ID="Hash" CssClass="form-control" />
                        </div>
                    </div>
